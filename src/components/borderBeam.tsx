...
export function BorderBeamComp() {
  return (
    <div className="w-screen flex relative justify-center items-center px-2 max-md:hidden opacity-90">
      ...
      <div className="w-screen h-full translate-y-[30%] absolute top-0 left-0 bg-gradient-to-b from-transparent via-black to-black"></div>
    </div>
  );
}
